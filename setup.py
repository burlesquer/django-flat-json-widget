...
setup(
    ...
    url='https://github.com/burlesquer/django-flat-json-widget',
    download_url='https://github.com/burlesquer/django-flat-json-widget/releases',
    ...
    extras_require={
        'test': [
            'openwisp-utils[qa] @ '
            'https://github.com/burlesquer/openwisp-utils/tarball/master',
